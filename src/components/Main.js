    ...
    return (
      ...
      >
        ...
        >
          ...
          <p>
            «بلوک» هم یک پلتفرم اجاره کتابه که بر بستر بلاکچین فعالیت می‌کنه.
        ...
        >
          ...
          <p>
            ...
            <p>
              بر خلاف کسب و کارهای تجاری که هدفشون حداکثر کردن سود
              سهامدارانشونه، کسب و کار اجتماعی با هدف برطرف کردن یک یا چند مشکل
              اجتماعی فعالیت می‌کنه. بنابراین کسب و کارهایی که هدف اصلی اون‌ها
              کسب سود حداکثری برای صاحبانشونه، حتی اگه فعالیت‌های اجتماعی هم
              انجام بدن، کسب و کار اجتماعی نامیده نمی‌شن.
              <br />
              <br />
              <h4>&bull;&#160;از نظر اقتصادی خودگردان هستن :</h4>
              <p>
                کسب و کارهای اجتماعی باید تمامی هزینه‌های خودشون رو از طریق فروش
                محصولات یا خدمات، تأمین کنن؛ بنابراین سازمان‌های خیریه علی‌رغم
                اینکه هدف اونها کاملا اجتماعیه «کسب و کار اجتماعی» نیستن،‌ چون
                از نظر اقتصادی خودگردان نیستن و هزینه‌هاشون از طریق دریافت
                کمک‌ها و هدایای مردمی و دولتی، تأمین می‌شه
              </p>
              <h4>
                &bull;&#160;در کسب و کار اجتماعی سودی میان سهامداران تقسیم
                نمیشه:
              </h4>
              <p>
                طبق شرط دوم هر کسب و کار اجتماعی باید از طریق درآمدی که از تجارت
                بدست می‌آره، هزینه‌های خودش رو پوشش بده. اگه درآمدهای یک کسب و
                کار اجتماعی بیشتر از هزینه‌های اون باشه و پس از پرداخت هزینه ها
                سود به دست اومده بین سهامداران تقسیم نمیشه، بلکه برای گسترش
                دامنه فعالیت‌های اجتماعی مجدداً در کسب و کار اجتماعی،
                سرمایه‌گذاری می‌شه.
                <br />
                البته توجه کنین که پولی که سرمایه گذاران در ابتدا سرمایه گذاری
                کردن بهشون برمی‌گرده و «سود» به میزان پولی میگیم که بعد از
                بازپرداخت همه دیون هنوز توی سیستم باقی می‌مونه.
              </p>
            </p>
            <p>
              در جمع‌بندی «کسب و کار اجتماعی» رو می‌تونیم کسب و کاری تعریف کنیم
              که «هدف اصلی تأسیس آن اجتماعیه» ، «ضرر ده نیست» و «سودی بین
              سهامداران تقسیم نمی‌کنه»
            </p>
          </p>
          {close}
        </article>
