      ...
      >
        ...
        >
          ...
          <p>
            ...
            پلتفرم هایی هستن که صاحبان خودروها رو به مسافران وصل می‌کنن. حتی
        ...
        >
          ...
          <p>
            ...
            افراد و خدمات فرصت های جدیدی برای خلق پول و ارزش به وجود
            بیارن.همانطور که در مقاله «فلان» توضیح دادم،
          </p>
          <p>
            هرچند این شرکت ها با متصل کردن ،‌ تولیدکننده‌ها و مصرف کننده‌ها،
            راننده ها و مسافرها ، دوستان و آشنایان و… ساختارهای جدید و مفیدی رو
            توی جامعه به وجود آوردن، اما مشکل واقعی وقتی مشخص شد که منافعی که از
            این راه به دست ‌می‌اومد به صورت ناعادلانه تقسیم شد. این کمپانی ها با
            قرار گرفتن در گلوگاه های حیاتی این تبادلات، سود و قدرت بیشتری رو
            نسبت به کاربران به دست می آوردن، درحالیکه ارزش نهایی رو کاربران به
            وجود می‌آرن.مثلا به نظر شما ارزش یک گروه تلگرامی رو اعضاش می‌سازن یا
            مدیرش؟
          </p>
          <p>
            با به رشد و گسترش بلاکچین و کسب و کارهای مبتنی بر اون، دنیا می‌تونه
            یک قدم دیگه به سمت عادلانه شدن برداره. در مرحله قبلی و با رشد
            اینترنت «پلتفرم‌ها» این فرصت رو به افراد دادن تابتونن دارایی‌های
            کوچیکشون رو به هم پیوند بدن و در قالب یک محصول بزرگ اما متنوع با
            «تولید انبوه» مقابله کنن.
          </p>
          <p />
          ...
          ارزش‌ها هستن برسه. برای اطلاع از جزییات بیشتر و اینکه چطور بلاکچین
          می‌تونه در حل این مشکل «عصای جادویی» ما باشه می‌تونید به «فلان» مقاله
          مراجعه کنین
          <p />
          {close}
        </article>
