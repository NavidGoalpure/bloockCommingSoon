    ...
    <div className="content">
      <div className="inner">
        ...
        <p>
          ...
          بلووک رو به عنوان یک استارتاپ تعطیل کنیم و انرژی‌مون رو روی حوزه های
          دیگه ای بزاریم.کارهایی که کردیم و محتواهایی که منتشر کردیم رو می‌تونین
          از لینک های پایین پیدا کنین
        </p>
