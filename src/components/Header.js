    ...
    <div className="content">
      <div className="inner">
        ...
        <p>
          ...
          کنین با این کار هم یک صرفه جویی ۸۰ درصدی تو خرید کتاب اتفاق
          می‌افته،‌هم درختای کمتری قطع میشه
        </p>
        <p>
          برای اطلاعات بیشتر درباره بلاکچین و تاثیر اون توی جامعه می‌تونین به
          وبلاگ
          <a href="#"> MrNewid </a>
          مراجعه کنین. {/* <a href="#">Creative Commons</a> license. */}
        </p>
      </div>
    </div>
    <nav>
